function [acc, kappa, f1, sens, spec, classwise_sens, classwise_sel, C] = eval_1maxcnn_many2one(nfilter, nchan)
    ...
    for fold = 1 : Nfold
        ...
        load(['./tensorflow_net/multitask_1max_cnn_3to1/cnn1d_sleep_357_',num2str(nfilter),'_(08)_eval_',num2str(nchan),'chan/n', num2str(fold), '/test_ret_model_acc.mat']);
        yh{fold} = double(yhat');
    end
    yh = cell2mat(yh);
    yt = cell2mat(yt);
