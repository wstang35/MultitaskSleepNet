function [acc, kappa, f1, sens, spec, classwise_sens, classwise_sel, C] = eval_deepcnn_many2one(nchan)
    ...
    for fold = 1 : Nfold
        ...
        load(['./tensorflow_net/deep_cnn_baseline_3to1/deepcnn_sleep_96_96_1024_1024_(08)_eval_',num2str(nchan),'chan/n', num2str(fold), '/test_ret_model_acc.mat']);
        yh{fold} = double(yhat');
    end
    yh = cell2mat(yh);
    yt = cell2mat(yt);
