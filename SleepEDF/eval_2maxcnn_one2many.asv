...
function [acc, kappa, f1, sens, spec, classwise_sens, classwise_sel, C] = eval_2maxcnn_one2many(nfilter, nchan, aggregation)
    ...
    for fold = 1 : Nfold
        ...
        load(['./tensorflow_net/wilson_2max_cnn_1to3/cnn1d_sleep_357_',num2str(nfilter),'_(08)_eval_',num2str(nchan),'chan/n', num2str(fold), '/test_ret_model_acc.mat']);
