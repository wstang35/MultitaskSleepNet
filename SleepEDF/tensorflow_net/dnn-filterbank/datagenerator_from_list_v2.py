...
class DataGenerator:
    def __init__(self, filelist, data_shape=np.array([129]),shuffle=False):
    ...
    def next_batch(self, batch_size):
        ...
        batch_x = np.ndarray([batch_size, self.data_shape[0]])
    ...
    # get the rest of the data if they are smaller than the size of one regular batch
    def rest_batch(self, batch_size):
        ...
        batch_x = np.ndarray([actual_len, self.data_shape[0]])
