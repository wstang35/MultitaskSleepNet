...
class CNN1DSleep(object):
    ...
    def __init__(
      self, time_length, freq_length, num_classes, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        self.h_pool_flat = tf.reshape(self.h_pool, [-1, num_filters_total*2])
        ...
        with tf.name_scope("output1"):
            W1 = tf.Variable(tf.truncated_normal([num_filters_total*2, num_classes], stddev=0.1), name="W1")
        ...
        with tf.name_scope("output2"):
            W2 = tf.Variable(tf.truncated_normal([num_filters_total*2, num_classes], stddev=0.1), name="W2")
        ...
        with tf.name_scope("output3"):
            W3 = tf.Variable(tf.truncated_normal([num_filters_total*2, num_classes], stddev=0.1), name="W3")
